...
basketball.achievement = Achievement.create(title: "Swoosh")
lit.achievement = Achievement.create(title: "Homer")
music.achievement = Achievement.create(title: "You rock!")
